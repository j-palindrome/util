...
export default function ParticlesBrush<T extends Record<string, any>>({
  params,
  ...settings
}: { params: T } & Partial<GroupBuilder<'particles', T>['settings']>) {
  const builder = new GroupBuilder('particles', settings, params)
  // @ts-ignore
